...
const Input = class {
    ...
    render() {
        return (core.h("div", { class: "material-input" }, core.h("input", { type: "text", placeholder: this.placeholder, autocomplete: "off", required: true, value: this.value, onInput: (event) => this.handleChange(event) }), core.h("hr", null), core.h("label", null, this.label)));
    }
